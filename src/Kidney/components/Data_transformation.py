...
from src.Kidney.utils.utils import save_object
...
class DataTransformation:
    ...
    def get_data_transformation(self):
        ...
        try:
            ...
            categorical_cols = ['red_blood_cells', 'pus_cell','pus_cell_clumps','bacteria','hypertension','diabetes_mellitus','coronary_artery_disease','appetite','peda_edema','aanemia','class']
